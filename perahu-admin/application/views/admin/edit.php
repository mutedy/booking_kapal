<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('admin/edit/'.$admin['admin_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="created_at" value="<?php echo ($this->input->post('created_at') ? $this->input->post('created_at') : $admin['created_at']); ?>" class="has-datepicker form-control" id="created_at" />
						</div>
					</div>
				</div>
			</div>
