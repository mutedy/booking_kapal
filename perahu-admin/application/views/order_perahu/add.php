    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Order Perahu Add</h3>
            </div>
            <?php echo form_open('order_perahu/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="perahu_id" value="<?php echo $this->input->post('perahu_id'); ?>" class="form-control" id="perahu_id" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="verified_at" value="<?php echo $this->input->post('verified_at'); ?>" class="has-datetimepicker form-control" id="verified_at" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="booking_at" class="control-label">Booking At</label>
						<div class="form-group">
							<input type="text" name="booking_at" value="<?php echo $this->input->post('booking_at'); ?>" class="has-datetimepicker form-control" id="booking_at" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="uploaded_at" value="<?php echo $this->input->post('uploaded_at'); ?>" class="has-datetimepicker form-control" id="uploaded_at" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="biaya" class="control-label">Biaya</label>
						<div class="form-group">
							<input type="text" name="biaya" value="<?php echo $this->input->post('biaya'); ?>" class="form-control" id="biaya" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="bukti_pembayaran_path" class="control-label">Bukti Pembayaran Path</label>
						<div class="form-group">
							<textarea name="bukti_pembayaran_path" class="form-control" id="bukti_pembayaran_path"><?php echo $this->input->post('bukti_pembayaran_path'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
