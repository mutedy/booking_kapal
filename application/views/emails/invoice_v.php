...
<body style="font: 14px/1.4; Georgia, serif; width: 800px; margin: 0 auto;">
		<div id="page-wrap" style="width: 800px; margin: 0 auto;">
			<textarea id="header" style="height: 15px; width: 100%; margin: 20px 0; background: #222; text-align: center; color: white; font: bold 15px Helvetica, Sans-Serif; text-decoration: uppercase; letter-spacing: 20px; padding: 8px 0px; border: 0; font: 14px Georgia, Serif; overflow: hidden; resize: none;">BOOKING INVOICE</textarea>
			<div id="identity">
				...
				<div id="logo" style="text-align: right; float: right; position: relative; margin-top: 25px; border: 1px solid #fff; max-width: 1080px; max-height: 1080px; overflow: hidden;">
			...
			<div id="customer" style="overflow: hidden; width: 800px; margin: 0 auto;">
				...
				<table id="meta" style="border-collapse: collapse; margin-top: 1px; width: 300px; float: right;">
					<tr>
						...
						<td class="meta-head" style="border: 1px solid black; padding: 5px; text-align: right;"><textarea style="border: 0; font: 14px Georgia, Serif; overflow: hidden; resize: none; width: 100%; height: 20px; text-align: right;"><?= $pemesanan_id ?></textarea></td>
					</tr>
					<tr>

						<td class="meta-head" style="border: 1px solid black; padding: 5px; text-align: left; background: #eee;">Tanggal</td>
						<td style="border: 1px solid black; padding: 5px; text-align: right;"><textarea id="date" style="border: 0; font: 14px Georgia, Serif; overflow: hidden; resize: none; width: 100%; height: 20px; text-align: right;"><?= $created_at ?></textarea></td>
					</tr>
					<tr>
			...
			<table id="items" style="border-collapse: collapse; clear: both; width: 100%; margin: 30px 0 0 0; border: 1px solid black; ">
				...
				<tr>
					<th style="border: 1px solid black; padding: 5px; background: #eee;">Nama Kapal</th>
				...
				<tr>
					...
					<td class="total-value"><div id="total">Menunggu Pembayaran</div></td>
				</tr>
				
				<tr bgcolor="#000000">
				<td colspan="5" style="text-align: center; color:white;"> Pembayaran melalui transfer ke nomor rekening Mandiri : 176-00-0117744-1</td>
				</tr>
				<tr bgcolor="#000000">
				<td colspan="5" style="text-align: center; color:white;"> Atas nama Ahmad Mutedi sebagai admin </td>
				</tr>
			</table>
			<br><br>
